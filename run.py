...
def main():
    print("main")
    # data = get_data()
    data = {'Lundi': {'date': '02/03/20', 'lessons': [
        {'module': 'IAS', 'course': 'IA et Jeu Vidéo', 'teachers': ['BOSSER Anne-Gwenn'], 'students': ['09PO-IAS'],
        ...
        {'module': 'IAS', 'course': 'IA et Jeu Vidéo', 'teachers': ['BOSSER Anne-Gwenn'], 'students': ['09PO-IAS'],
         'rooms': ['B005'], 'start_hour': {'h': 14, 'm': 20}, 'duration': {'h': 1, 'm': 30}}]},
            ...
            {'module': 'PRI', 'course': 'Sprint 0', 'teachers': [''], 'students': ['09PO-PRI'], 'rooms': [''],
             'start_hour': {'h': 17, 'm': 30}, 'duration': {'h': 1, 'm': 30}}]}, 'Jeudi': {'date': '05/03/20',
                                                                                           'lessons': [{'module': 'ERI',
                                                                                                        'course': 'low tech',
                                                                                                        'teachers': [
                                                                                                            'TOQUET Delphine'],
